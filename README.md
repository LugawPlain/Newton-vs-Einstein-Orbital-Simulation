...
*   **Planet 2 (Pink)** includes a Post-Newtonian correction term ($1/r^3$), which causes the orbit to precess over time, creating a beautiful "rosette" pattern similar to the famous precession of Mercury's perihelion.
